...
echo "开始运行 HS300 常规模型对比实验..."
echo "行情数据: $market_data"
echo "雪球数据: $snowball_csv"
echo "方法: mlp lstm alstm transformer xgboost no_graph static dynamic6m"
...
"$python_bin" -u run_rolling_experiments.py \
  ...
  --methods mlp lstm alstm transformer xgboost no_graph static dynamic6m \
