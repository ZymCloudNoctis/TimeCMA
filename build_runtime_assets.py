...
def parse_args():
    ...
    parser.add_argument("--graph_file", type=str, required=True, help="canonical graph csv path")
    parser.add_argument("--output_stock_pool", type=str, required=True, help="runtime stock pool output csv path")
    parser.add_argument("--output_graph", type=str, required=True, help="runtime graph output csv path")
...
def prepare_runtime_assets(market_data, stock_pool_file, graph_file, output_stock_pool, output_graph):
    ...
    missing_from_graph = [code for code in canonical_pool if code not in graph_codes]
